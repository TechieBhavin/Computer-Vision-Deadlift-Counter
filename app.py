...
class_label   = ctk.CTkLabel(app, height=40, width=120,   text_color='white')
class_label.place(x=10, y =1)
class_label.configure(text='STAGE')

counter_label = ctk.CTkLabel(app, height=40, width=120,   text_color='white')
counter_label.place(x=160,y=1)
counter_label.configure(text='REPS')

prob_label    = ctk.CTkLabel(app, height=40, width=120,   text_color='white')
...
prob_box		= ctk.CTkLabel(app, height=40, width=120,   text_color='white', fg_color='blue')
